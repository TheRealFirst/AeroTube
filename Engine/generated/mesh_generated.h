...
#ifndef FLATBUFFERS_GENERATED_MESH_FBMESH_H_
#define FLATBUFFERS_GENERATED_MESH_FBMESH_H_
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Vertex FLATBUFFERS_FINAL_CLASS {
 private:
  FBMesh::Vec3 position_;
  FBMesh::Vec3 normal_;
  FBMesh::Vec3 color_;
  FBMesh::Vec2 texcoord_;
 ...
 public:
  ...
  Vertex(const FBMesh::Vec3 &_position, const FBMesh::Vec3 &_normal, const FBMesh::Vec3 &_color, const FBMesh::Vec2 &_texcoord)
      : position_(_position),
        normal_(_normal),
        color_(_color),
        texcoord_(_texcoord) {
  }
  const FBMesh::Vec3 &position() const {
    return position_;
  }
  const FBMesh::Vec3 &normal() const {
    return normal_;
  }
  const FBMesh::Vec3 &color() const {
    return color_;
  }
  const FBMesh::Vec2 &texcoord() const {
    return texcoord_;
  }
};
...
struct Mesh FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<const FBMesh::Vertex *> *vertices() const {
    return GetPointer<const ::flatbuffers::Vector<const FBMesh::Vertex *> *>(VT_VERTICES);
  }
...
struct MeshBuilder {
  ...
  void add_vertices(::flatbuffers::Offset<::flatbuffers::Vector<const FBMesh::Vertex *>> vertices) {
...
inline ::flatbuffers::Offset<Mesh> CreateMesh(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<const FBMesh::Vertex *>> vertices = 0,
...
inline ::flatbuffers::Offset<Mesh> CreateMeshDirect(
    ...
    const std::vector<FBMesh::Vertex> *vertices = nullptr,
    const std::vector<uint32_t> *indices = nullptr,
    const char *material = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto vertices__ = vertices ? _fbb.CreateVectorOfStructs<FBMesh::Vertex>(*vertices) : 0;
  auto indices__ = indices ? _fbb.CreateVector<uint32_t>(*indices) : 0;
  auto material__ = material ? _fbb.CreateString(material) : 0;
  return FBMesh::CreateMesh(
      _fbb,
      name__,
      vertices__,
      indices__,
...
inline const FBMesh::Mesh *GetMesh(const void *buf) {
  return ::flatbuffers::GetRoot<FBMesh::Mesh>(buf);
}

inline const FBMesh::Mesh *GetSizePrefixedMesh(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<FBMesh::Mesh>(buf);
}
...
inline bool VerifyMeshBuffer(
  ...
  return verifier.VerifyBuffer<FBMesh::Mesh>(MeshIdentifier());
}

inline bool VerifySizePrefixedMeshBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<FBMesh::Mesh>(MeshIdentifier());
}

inline void FinishMeshBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FBMesh::Mesh> root) {
...
#endif  // FLATBUFFERS_GENERATED_MESH_FBMESH_H_
